#ifndef _IRDMA_KCOMPAT_GEN_H_
#define _IRDMA_KCOMPAT_GEN_H_
...
#define NEED_RDMA_UMEM_BLOCK_ITER_NEXT
#define HAVE_IB_UMEM_NUM_DMA_BLOCK
#endif /* _IRDMA_KCOMPAT_GEN_H_ */
