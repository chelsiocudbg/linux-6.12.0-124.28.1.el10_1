...
/*
 * crt_ena is to modify resource limits for CRT protocol family
 */
bool crt_ena;
module_param(crt_ena, bool, 0444);
MODULE_PARM_DESC(crt_ena, "CRT enable, 1=enable CRT-specific resource limits");
...
int setup_svc_mem_alloc_irdma( void *(*svc_iser_kmalloc)(size_t,int,void*),
...
EXPORT_SYMBOL_GPL(setup_svc_mem_alloc_irdma);
